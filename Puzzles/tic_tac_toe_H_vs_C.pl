% The tic-tac-toe game, played user against the computer.
% A 3 x 3 grid is printed. The choice of th next move is made
% by typing an index from 1 to 9, the grid is printed like this.
% |1|2|3|
% |4|5|6|
% |7|8|9|
...
% Obtain the best possible position for a computer move. 		
...
% In case human is in a winning position, defend.
...
% In case human is not in a winning position
